...
<html>
	...
	<body>
		<div class="header">
			<h1><a href="#" title="کاکتوس مووی">کاکتوس مووی</a></h1>
			<p>کاکتوس مووی یک وبسایت فارسی می باشد برای دانلود فیلم و سریال های خارجی به زبان اصلی و همراه با زیرنویس فارسی آنها که تحت هیچ شرایط هیچ سانسوری روی فیلم ها قرار داده نمی شود.</p>
		</div>
	...
	<div class="main">
		<div class="left">
			<div class="left_block">
				<h3>کاکتوس مووی</h3>
				<div class="logo">
					<img src="content/image/logo.png" width="200" title="کاکتوس مووی" alt="کاکتوس مووی" />
				</div>
			</div>
